...
import com.displayfort.app.adapter.MediaItemListAdapter;
...
public class MediaItemListActivity extends BaseActivity implements View.OnClickListener {
    private Context context;
    private MediaViewViewHolder viewholder;
    private MediaItemListAdapter mediaListAdapter;
    private ArrayList<MediaDao> mediaList;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.media_item_layout);
        context = this;
        SetToolBar("Library");
    ...
    private void setAdapter() {
        ...
        mediaList = getList();
        mediaListAdapter = new MediaItemListAdapter(context, mediaList, viewholder.mTopIv, new OnMediaClick() {
            @Override
