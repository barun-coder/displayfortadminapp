...
public class ScreenScheduleListAdapter extends RecyclerView.Adapter<ScreenScheduleListAdapter.ViewHolder> {
    ...
    public ScreenScheduleListAdapter(Context context, ArrayList<ScheduleDao> searchList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_screen_schedule_layout, viewGroup, false);
