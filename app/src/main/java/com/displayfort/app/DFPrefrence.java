...
public class DFPrefrence {
    ...
    private static final String SHARED_PREFERENCE_NAME = "DFSharedPreference";
    private static final String SHARED_PREFERENCE_NAME_TUTORIAL = "DFSharedPreferenceTUORIAL";
